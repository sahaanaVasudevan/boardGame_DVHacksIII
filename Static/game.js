...
var actions = ["Hop","Sing","Dance","Roll","Sneek Peak","March"];
...
async function moveUser(randomNumber, actionRandomNumber)
{
  ...
  document.getElementById("userTurnText").innerHTML = "User " + (currentUser+1) + "'s Turn";
  ...
  document.getElementById("divThumbsUp").style.display="";
